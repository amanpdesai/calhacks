...
def text_to_wav(given_text, output_dir="../../Assets/TextToSpeech/"):
    ...
    # Count all files in the directory (assuming only .wav files exist)
    i = len(os.listdir(output_dir)) + 1

    # Create a new file path using the count
...
if __name__ == "__main__":
    text_to_wav("Hello, I am a demo of the text to speech service.", output_dir="./")
