...
public static class WavUtility
{
    ...
    public static byte[] ToWavBytes(AudioClip clip)
    {
        using (MemoryStream memoryStream = new MemoryStream())
        {
            ...
            // Write chunk size (36 + SubChunk2Size)
            memoryStream.Write(BitConverter.GetBytes(36 + samples * channels * 2), 0, 4);
            ...
            memoryStream.Write(BitConverter.GetBytes((short)(channels * 2)), 0, 2);
            ...
            foreach (var sample in samplesData)
            {
                ...
                memoryStream.Write(BitConverter.GetBytes(intSample), 0, 2);
            }
